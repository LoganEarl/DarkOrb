...
import { FEATURE_VISUALIZE_WORK } from "utils/featureToggles/FeatureToggleRegistry";
...
export class WorkerProcess extends Process {
    ...
    focusReloader: ScheduledJob = new ScheduledJob(_shardWorkerSystem._reloadFocus, _shardWorkerSystem, 10);
